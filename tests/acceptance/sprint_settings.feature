Feature: Sprint Settings
  ...
  Scenario: Edit sprint title
    Given the sprint "Sprint Foo Bar" does not exist
    When I go to the "Sprint 42" sprint overview
  ...
  Scenario: Change project of the sprint
    Given the "Some Other Project" project exists
    When I go to the "Sprint 42" sprint overview
  ...
  Scenario: Duplicate title
    Given a sprint "Sprint Foo Bar" exists for the "Wikidata" project
    When I go to the "Sprint 42" sprint overview
    And I fill in "title" with "Sprint Foo Bar"
    And I press "save-sprint-settings"
